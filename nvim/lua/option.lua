...
local options = {
	...
	foldmethod = "expr", -- Set the fold method to "expr"
	foldexpr = "v:lua.vim.treesitter.foldexpr()", -- Use treesitter for folding expressions
	foldlevelstart = 99, -- Set initial fold level to prevent full folding
}
